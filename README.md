...
**지원 환경:** Windows x64 · **정식 릴리즈:** `v1.1.0` · **배포 형식:** 포터블 실행 파일 및 설치형 Windows 패키지
...
1. [GitHub Releases](https://github.com/hwandroid921/TokenMonitor/releases)에서 `TokenMonitor-1.1.0-x64.exe`를 다운로드합니다.
